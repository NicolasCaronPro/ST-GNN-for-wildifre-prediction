...
def process_test(testname, testDate, pss, geo, testd_departement, dir_output, features, doDatabase):
    ...
    x_train = read_object('x_train_'+prefix_train+'.pkl', dir_train)
...
#test('Ain', testDates, geo, geo, testd_departement, dir_output, features, doDatabase)

# 2023 test Doubs
testd_departement = ['departement-25-doubs']
#test('Doubs', testDates, geo, geo, testd_departement, dir_output, features, doDatabase)

# 2023 test Yvelines
testd_departement = ['departement-78-yvelines']
#test('Yvelines', testDates, geo, geo, testd_departement, dir_output, features, doDatabase)