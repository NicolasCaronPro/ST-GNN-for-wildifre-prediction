...
if doTest:
    ...
    if graph_method == 'node':
        ...
        models = [
                ('Zhang_search_full_0_10_one_nbsinister-kmeans-5-Class-Dept_classification_weightedcrossentropy'),
                ('ConvLSTM_search_full_0_10_one_nbsinister-kmeans-5-Class-Dept_classification_weightedcrossentropy'),
                ('ResNet_search_full_0_all_one_nbsinister-kmeans-5-Class-Dept_classification_weightedcrossentropy'),
        ]
    ...
    df_metrics.to_csv(dir_output / prefix / f'df_metrics_{graph_method}_cnn.csv')
