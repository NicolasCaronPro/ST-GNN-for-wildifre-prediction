...
if doTest:
    ...
    if graph_method == 'node':
        ...
        models = [
                ...
                #('graphcast_search_full_10_one_nbsinister-kmeans-5-Class-Dept_classification_weightedcrossentropy'),
                ...
                #('MultiScaleGraph_search_full_all_one_nbsinister-kmeans-5-Class-Dept_classification_weightedcrossentropy'),
                ...
                ('filterICML-LSTM-soft-weight-all_search_full_all_one_nbsinister-kmeans-5-Class-Dept_classification_weightedcrossentropy'),
