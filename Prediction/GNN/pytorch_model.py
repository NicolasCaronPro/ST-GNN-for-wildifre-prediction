...
class ModelTorch():
    def __init__(self, model_name, batch_size, lr, target_name, task_type,
                 features_name, ks, out_channels, dir_output, loss='mse', name='ModelTorch', device='cpu'):
...
class Model_Torch(ModelTorch):
    def __init__(self, model_name, batch_size, lr, target_name, task_type, out_channels, dir_output, features_name, ks, loss, name, device):
        super().__init__(model_name, batch_size, lr, target_name, task_type, features_name, ks, out_channels, dir_output, loss=loss, name=name, device=device)
    ...
    def create_train_val_test_loader(self, graph, df_train, df_val, df_test):
        ...
        if (self.dir_output / 'train_loader.pkl').is_file():
            ...
            self.train_loader = DataLoader(train_dataset, self.batch_size, True)
    ...
    def create_loader(self, graph, df):
