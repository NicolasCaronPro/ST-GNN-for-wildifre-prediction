...
if name_exp.find('voting') != -1: 
    ...
    models = [ #('catboost_search_full_all_one_nbsinister-kmeans-5-Class-Dept_classification_softmax-dual', None, None, None),
              #('ordered_full_full_75_one_nbsinister-kmeans-5-Class-Dept_classification_probit', None, None, None),
              #('ordered_search_full_75_one_nbsinister-kmeans-5-Class-Dept_classification_logit', None, None, None),
              ('xgboost_full_full_all_one_nbsinister-kmeans-5-Class-Dept_regression_rmse', None, None, MyOrderedModel({'distr': 'logit'})),
              #('xgboost_full_smote_all_one_nbsinister-kmeans-5-Class-Dept_ordinal-classification_softmax', None, None, None),
              #('xgboost_full_full_all_one_nbsinister-kmeans-5-Class-Dept_classification_softmax-risk-kappa-1', None, None, None),
              #('xgboost_full_full_all_one_nbsinister-kmeans-5-Class-Dept_classification_softmax-risk-kappa-2', None, None, None),
              #('xgboost_search_full_all_one_nbsinister-kmeans-5-Class-Dept-cubic-Specialized_classification_softmax-dual', None, None, None),
              #('xgboost_search_full_all_one_nbsinister-kmeans-5-Class-Dept-cubic-Specialized_classification_softmax', None, None, None),
              #('xgboost_search_smote_all_one_nbsinister-kmeans-5-Class-Dept-cubic-Specialized_ordinal-classification_softmax', None, None, None),
              #('xgboost_search_full_all_one_nbsinister-kmeans-5-Class-Dept-cubic-Specialized_classification_dice', None, None, None),
              #('xgboost_search_full_all_one_nbsinister-kmeans-5-Class-Dept-cubic-Specialized_classification_softmax-risk-dual', None, None, None),
              #('xgboost_search_full_all_one_nbsinister-kmeans-5-Class-Dept-cubic-Specialized_classification_softmax-risk', None, None, None)
              ]
...
if doTest:
    ...
    models = [
        ...
        #('ordered_full_full_75_one_nbsinister-kmeans-5-Class-Dept_classification_probit'),
        #('ordered_search_full_75_one_nbsinister-kmeans-5-Class-Dept_classification_logit'),

        #('xgboost_search_full_all_one_nbsinister-kmeans-5-Class-Dept_classification_dice'),
        #('xgboost_search_full_all_one_nbsinister-kmeans-5-Class-Dept_classification_softmax-risk'),
        #('xgboost_full_full_all_one_nbsinister-kmeans-5-Class-Dept_classification_softmax-risk-kappa-1'),
        #('xgboost_full_full_all_one_nbsinister-kmeans-5-Class-Dept_classification_softmax-risk-kappa-2'),
        #('xgboost_search_full_all_one_nbsinister-kmeans-5-Class-Dept-cubic-Specialized_classification_softmax-dual'),
        #('xgboost_search_full_all_one_nbsinister-kmeans-5-Class-Dept-cubic-Specialized_classification_softmax'),
        #('xgboost_search_full_all_one_nbsinister-kmeans-5-Class-Dept-cubic-Specialized_ordinal-classification_softmax'),
        #('xgboost_search_smote_all_one_nbsinister-kmeans-5-Class-Dept-cubic-Specialized_ordinal-classification_softmax'),
        #('xgboost_search_full_all_one_nbsinister-kmeans-5-Class-Dept-cubic-Specialized_classification_softmax-risk'),
        #('xgboost_search_full_all_one_nbsinister-kmeans-5-Class-Dept-cubic-Specialized_classification_softmax-risk-dual'),
        #('xgboost_search_full_all_one_nbsinister-kmeans-5-Class-Dept-cubic-Specialized_classification_dice'),
        #('xgboost_search_smote_all_one_nbsinister-kmeans-5-Class-Dept_classification_softmax'),
        #('xgboost_full_full_all_one_nbsinister-kmeans-5-Class-Dept_ordinal-classification_softmax'),
        #('xgboost_full_smote_all_one_nbsinister-kmeans-5-Class-Dept_ordinal-classification_softmax'),
        ('xgboost_full_full_all_one_nbsinister-kmeans-5-Class-Dept_regression_rmse'),
        ...
        #('filter-xgboost-soft-weight-5_full_all_one_nbsinister-kmeans-5-Class-Dept_classification_softmax'),
        #('filter-xgboost-soft-weight-1_full_all_one_nbsinister-kmeans-5-Class-Dept_classification_softmax'),
