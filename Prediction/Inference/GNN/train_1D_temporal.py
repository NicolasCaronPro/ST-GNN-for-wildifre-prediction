...
if name_exp.find('voting') != -1:
    ...
    voting_models = []
    models = [#('DilatedCNN', 'search_full_all_one_nbsinister-kmeans-5-Class-Dept_classification_weightedcrossentropy', 5),
    ...
    gnn_models = [
            #('net', False, 'full_all_one_nbsinister-kmeans-5-Class-Dept_classification_weightedcrossentropy', 5),
...
if doTest:
    ...
    if graph_method == 'node':
        ...
        models = [
                ...
                #('LSTM_search_full_all_one_nbsinister-kmeans-5-Class-Dept_classification_weightedcrossentropy'),
                ('NetMLP_full_full_all_one_nbsinister-kmeans-5-Class-Dept_classification_dice'),
                ('NetMLP_full_full_all_one_nbsinister-kmeans-5-Class-Dept_classification_ordinal-dice'),

                ('NetMLP_full_full_all_one_nbsinister-kmeans-5-Class-Dept_classification_weightedcrossentropy'),
                ('NetMLP_full_full_all_one_nbsinister-kmeans-5-Class-Dept_classification_kappa'),
